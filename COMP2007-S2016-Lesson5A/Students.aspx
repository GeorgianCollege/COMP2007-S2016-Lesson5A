<%@ Page Title="Students" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Students.aspx.cs" Inherits="COMP2007_S2016_Lesson5A.Students" %>
                ...
                <asp:GridView runat="server" CssClass="table table-bordered table-striped table-hover" 
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField HeaderText="Edit" Text="<i class='fa fa-pencil-square-o fa-lg'></i> Edit" NavigateUrl="~/StudentDetails.aspx"
                            ItemStyle-CssClass="btn btn-primary btn-sm" DataNavigateUrlFields="StudentID"
                            DataNavigateUrlFormatString="StudentDetails.aspx?StudentID={0}" ControlStyle-ForeColor="White" ItemStyle-VerticalAlign="Middle" />
